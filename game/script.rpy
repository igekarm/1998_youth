...
label start:
    ...
    show screen hud
    "Это пока что просто набросок."

    show screen hud
    "Но скоро, я надеюсь:-)."

    show screen hud
    "Я очень надеюсь, и я буду стараться."

    show screen hud
    "Сделаю, что то стящее!"

    show screen hud
    "Свободный режим я еще изучаю, по этому до окончания игры следуй инструкции)))."

    show screen hud
    "В верхней части экрана имеются иконки, часть из них уже рабочие."

    show screen hud
    "Слева, индикая времени дня со временем и стерками перемоти, на один час и на два часа"

    show screen hud
    "По центру, индикация состояния персонажа:"

    show screen hud
    "Здоровье, голод. жажда, гигиена и усталость."

    show screen hud
    "Справа есть кнопки карты, инвентаря и телефон (пока что просто изображение телефона, я только учусь)"

    show screen hud
    "Там же имеится кнопка навыков, которые открываются при нажатии."

    show screen hud
    "В дальнейшем, будет доработка на каждой локации несколько мини локаций."

    show screen hud
    "Ярлыки которых будут в нижней части экрана справа или слева, еще не решил."
    ...
    show screen hud
    "Самое главное, будедь честен, по завершению, скажи что ты думаешь о том, что я сделал."
...
screen inventory:
    ...
    add "images/inventory.png" xalign 0.5 yalign 0.5
    # Опционально, можно добавить кнопки или элементы для взаимодействия
    textbutton "Назад" action Return() xalign 0.5 yalign 1.0
