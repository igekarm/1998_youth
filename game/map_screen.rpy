...
screen map:
    ...
    for marker in map_markers:
        imagebutton:
            idle marker["icon"]  # исправлено на корректный ключ словаря
            xpos marker["x"]  # исправлено на корректный ключ словаря
            ypos marker["y"]  # исправлено на корректный ключ словаря
            action ShowMenu(marker["screen"])  # исправлено на корректный ключ словаря
